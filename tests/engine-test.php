 ...
 *
 * Covers the 9 reference cases plus edge cases.
 *
...
// ---------------------------------------------------------------- fixtures.
const CAT1 = 101; // "Category 1" (Hoodie on the demo site).
const CAT2 = 102; // "Category 2" (Shorts).
const CAT3 = 103; // "Category 3" (T-Shirts).

function promo_cat1_20(): Promotion { // Demo promo 1.
...
function promo_flash_30( array $product_ids ): Promotion { // Demo promo 2.
	return Promotion::from_array( array(
		'id'          => 2,
		'name'        => 'Flash -30%',
		'type'        => Promotion::TYPE_PERCENT,
...
function promo_bogo(): Promotion { // Demo promo 3: buy 2 get 1 in CAT2.
	return Promotion::from_array( array(
		'id'           => 3,
		'name'         => 'Buy 2 get 1',
...
function promo_bundle(): Promotion { // Demo promo 4: any 2 from CAT3 for $250.
	return Promotion::from_array( array(
		'id'           => 4,
...
function promo_cart_tiers(): Promotion { // Demo promo 5.
	return Promotion::from_array( array(
		'id'       => 5,
		'name'     => 'Cart threshold',
...
check( 'ex8: -50% x -60% capped at -70% -> 30.00', 30.00, $r->lines[0]->unit_price );
